 ...
 * @subpackage Structs
 */
class IFT_DocTransportesResponseStatus extends AbstractStructBase
{
    /**
     * The ReturnCode
     ...
     * @uses IFT_DocTransportesResponseStatus::setReturnCode()
     * @uses IFT_DocTransportesResponseStatus::setReturnMessage()
