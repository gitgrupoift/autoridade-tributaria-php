 ...
 * @subpackage Structs
 */
class IFT_ArrendamentoImovel extends AbstractStructBase
{
    /**
     * The distrito
     ...
     * @uses IFT_ArrendamentoImovel::setDistrito()
     * @uses IFT_ArrendamentoImovel::setConcelho()
     * @uses IFT_ArrendamentoImovel::setFreguesia()
     * @uses IFT_ArrendamentoImovel::setTipo()
     * @uses IFT_ArrendamentoImovel::setSeccao()
     * @uses IFT_ArrendamentoImovel::setArtigo()
     * @uses IFT_ArrendamentoImovel::setFracao()
     * @uses IFT_ArrendamentoImovel::setArvCol()
     * @uses IFT_ArrendamentoImovel::setCodigoPostal()
     * @uses IFT_ArrendamentoImovel::setUnidadeFuncional()
     * @uses IFT_ArrendamentoImovel::setLocalidade()
     * @uses IFT_ArrendamentoImovel::setMorada()
     * @uses IFT_ArrendamentoImovel::setNumeroLote()
     * @uses IFT_ArrendamentoImovel::setAndar()
     * @uses IFT_ArrendamentoImovel::setParteArrendada()
     * @uses IFT_ArrendamentoImovel::setParteComum()
     * @uses IFT_ArrendamentoImovel::setBemOmisso()
