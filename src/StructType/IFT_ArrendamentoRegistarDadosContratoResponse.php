 ...
 * @subpackage Structs
 */
class IFT_ArrendamentoRegistarDadosContratoResponse extends AbstractStructBase
{
    /**
     * The codigo
     ...
     * @uses IFT_ArrendamentoRegistarDadosContratoResponse::setCodigo()
     * @uses IFT_ArrendamentoRegistarDadosContratoResponse::setMensagem()
     * @uses IFT_ArrendamentoRegistarDadosContratoResponse::setNumeroContrato()
     * @uses IFT_ArrendamentoRegistarDadosContratoResponse::setErros()
     * @param int $codigo
     * @param string $mensagem
     * @param int $numeroContrato
     * @param \IFT_Arrendamento\StructType\IFT_ArrendamentoErros $erros
     */
    public function __construct($codigo = null, $mensagem = null, $numeroContrato = null, \IFT_Arrendamento\StructType\IFT_ArrendamentoErros $erros = null)
    {
        $this
            ->setCodigo($codigo)
