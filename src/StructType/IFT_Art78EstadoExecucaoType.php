...
/**
 * This class stands for EstadoExecucaoType StructType
 * @package IFT_Art78
 * @subpackage Structs
 */
class IFT_Art78EstadoExecucaoType extends AbstractStructBase
{
    /**
     * The CodigoEstado
     ...
     * The DescricaoEstado
     * Meta information extracted from the WSDL
     * - documentation: Descricao do estado da execucao. A utilização desta estrutura prevê que, nas situações de erro, seja indicado detalhadamente qual o motivo do erro no campo DescricaoEstado. Por exemplo, no caso de do erro '001 - Erro:
     * Validação de parâmetros de entrada' a descrição do erro deve indicar qual o nome do campo que falhou na validação.
     * @var string
     */
    public $DescricaoEstado;
    /**
     * Constructor method for EstadoExecucaoType
     * @uses IFT_Art78EstadoExecucaoType::setCodigoEstado()
     * @uses IFT_Art78EstadoExecucaoType::setDescricaoEstado()
     ...
     * @param int $codigoEstado
     * @return \IFT_Art78\StructType\IFT_Art78EstadoExecucaoType
     */
