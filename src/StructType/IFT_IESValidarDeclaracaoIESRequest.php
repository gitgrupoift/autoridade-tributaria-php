...
/**
 * This class stands for validarDeclaracaoIESRequest StructType
 * @package IFT_IES
 * @subpackage Structs
 */
class IFT_IESValidarDeclaracaoIESRequest extends AbstractStructBase
{
    /**
    ...
    public $declaracao;
    /**
     * Constructor method for validarDeclaracaoIESRequest
     * @uses IFT_IESValidarDeclaracaoIESRequest::setVersaoDeclaracao()
     * @uses IFT_IESValidarDeclaracaoIESRequest::setDeclaracao()
     ...
     * @param string $versaoDeclaracao
     * @return \IFT_IES\StructType\IFT_IESValidarDeclaracaoIESRequest
     */
