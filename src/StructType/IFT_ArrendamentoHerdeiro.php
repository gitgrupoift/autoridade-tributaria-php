 ...
 * @subpackage Structs
 */
class IFT_ArrendamentoHerdeiro extends AbstractStructBase
{
    /**
     * The nif
     ...
     * @uses IFT_ArrendamentoHerdeiro::setNif()
     * @uses IFT_ArrendamentoHerdeiro::setQuotaParte()
     * @uses IFT_ArrendamentoHerdeiro::setNifHeranca()
     * @param int $nif
